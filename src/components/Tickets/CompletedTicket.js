...
import {startUpdateStatus,startRemoveTicket} from '../../actions/ticketAction'
                        ...
                        this.props.tickets.map(ticket=>{
                            if(ticket.isResolved){
                                return (<tr key={ticket._id}>
                                    <td>{ticket.code}</td>
                                    <td>{this.props.customer.find(cust=>cust._id == ticket.customer).name}</td>
                                    <td>{this.props.department.find(dept=>dept._id == ticket.department).name}</td>
